...
namespace WebUI.Controllers
{
    public class LoginController : Controller
    {
        ...
        {
            using var _context = new EmlakJetContext();
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (tokenModel != null)
                    {
                        ...
                        if (tokenModel.Token != null)
                        {
                            ...
                            TempData["LoginSuccess"] = $"Hoş Geldiniz, {user.Name}";
            ...
            TempData["LoginFailed"] = "Lütfen kullanıcı adınızı veya şifrenizi kontrol ediniz";
            return View();
        }
    ...
    EmlakJet</p>
            ...
            {
                message.From.Add(new MailboxAddress("EmlakJet", username));
